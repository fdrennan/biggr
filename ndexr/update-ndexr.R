...
s3_upload_file('ndexr-files', 'startup.sh', 'startup.sh', make_public = TRUE)
s3_upload_file('ndexr-files', '.Renviron.gpu', '.Renviron.gpu', make_public = TRUE)
s3_upload_file('ndexr-files', 'ndexr-gpu', 'ndexr-gpu', make_public = TRUE)
s3_upload_file('ndexr-files', 'install_keras.R', 'install_keras.R', make_public = TRUE)
s3_upload_file('ndexr-files', 'keras_model.R', 'keras_model.R', make_public = TRUE)
s3_upload_file('ndexr-files', 'nginx.conf', 'nginx.conf', make_public = TRUE)
s3_upload_file('ndexr-files', 'shiny-server.conf', 'shiny-server.conf', make_public = TRUE)
