...
cd /home/ubuntu/productor && /usr/local/bin/docker-compose -f docker-compose-dev.yaml -d --build productor_initdb
cd /home/ubuntu/productor && /usr/local/bin/docker-compose -f docker-compose-dev.yaml up -d --remove-orphans
